      ...
      <div className="container-narrow">
        ...
        <header className="surv-header">
          ...
          <p className="surv-desc">
            ...
            navigate negotiation at work\u2009—\u2009and how AI might help level
            the playing field.
          </p>
        ...
        <section className="surv-impact wine-gradient">
          ...
          <p className="surv-impact-body">
            ...
            dismantle the barriers women face in negotiation. Your story\u2009—\u2009even
            anonymized\u2009—\u2009has the power to shift policy, reshape training
